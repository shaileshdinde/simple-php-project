...
if (isset($_POST['submit'])) {
    ...
    $data = mysqli_query($connection, "INSERT INTO city(name,status) VALUES('$name','1')");
...
<head>
    <title><?=$projectName?> : Admin Add City </title>
...
<body>
    ...
    <div class="row col-lg-4 col-xs-12  col-lg-offset-2">
        <div class="panel panel-primary">
            <div class="panel-heading text-center">Add City</div>
            <div class="panel-body">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter City Name" required pattern="[a-zA-Z\s]+">
                    </div>                    
            </div>
