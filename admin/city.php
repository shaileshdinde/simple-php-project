...
if (isset($_POST['update'])) {
    ...
    try {
        $data = mysqli_query($connection, "UPDATE city SET status = '$status' WHERE id = '$id'");
...
<head>
    <title><?=$projectName?> : Admin City List </title>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <table id="example" class="display" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($connection, "SELECT * FROM city");
                        $srno = 0;
