...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($data) == 1) {
        if ($newPassword == $confirmPassword) {
            ...
            $data = mysqli_query($connection, "UPDATE user SET password = '$encPassword' WHERE email = '$username'");
...
<head>
    <title><?=$projectName?> : User Change Password </title>
...
<body>
    ...
    <div class="row col-lg-4 col-xs-12  col-lg-offset-2">
        <div class="panel panel-success">
            <div class="panel-heading text-center">Change User Password </div>
